...
@php
    ...
    $dc_channels = [['id' => 821828287406800916, 'name' => 'test'], ['id' => 812333539298902089, 'name' => 'general']];
...
<div class="container-fluid">
    ...
    <div id="dc-body" class="row multi-msg-form" style="display: none;">
        <div class="col-md-12">
            <p class="heading">Poslat zprávu do vybraných discord kanálů</p>
            <form action="{{route('send-dc-multimsg')}}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-2 groups-panel">
                        <div class="form-group text-center">
                            <p>Vyber kanály:</p>
                        @foreach($dc_channels as $channel)
                            <label for="channel">{{$channel['name']}}</label>
                            <input type="checkbox" class="checkbox" name="channel" value={{$channel['id']}}><br>
                        @endforeach
                        </div>
                    </div>
                    <div class="col-md-4 msg-panel">
