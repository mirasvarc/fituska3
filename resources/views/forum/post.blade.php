        ...
        <div class="col">
            <div class="back-button">
                ...
                @if($post->isAuthor())
                    ...
                    {!!Form::open(['action' => ['PostController@edit', $topic->id, $post->id], 'method' => 'POST', 'style' => 'float:right;margin-right:5px;'])!!}
            ...
            <div class="post">
                ...
                <div class="post-files">
                    ...
                    @foreach($post->files()->get() as $file)
                        <p class="post-file"><a href="/storage/files/forum/{{$file->path}}" target="_blank">{{$file->name}}</a></p>
                    @endforeach
                </div>
                @endif
            </div>
